...
- **🔄 Drag-and-Drop Workflow:** Fully interactive Kanban board powered by `@hello-pangea/dnd` for smooth task management.
...
- **Drag & Drop:** @hello-pangea/dnd (Beautiful and accessible drag and drop for lists)
